...
final class APIClient {
    ...
    func synthesizeSpeech(baseURL: String, text: String, style: String = "warm_female", speed: Double = 0.9, gainDb: Double = 9.0) async throws -> Data {
        ...
        body.append("\r\n--\(boundary)\r\n".data(using: .utf8)!)
        body.append("Content-Disposition: form-data; name=\"gain_db\"\r\n\r\n".data(using: .utf8)!)
        body.append(String(format: "%.2f", gainDb).data(using: .utf8)!)
        body.append("\r\n--\(boundary)--\r\n".data(using: .utf8)!)
        request.httpBody = body
